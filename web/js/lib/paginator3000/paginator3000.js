 ...
 */
var Paginator = function(paginatorHolderId, pagesTotal, pagesSpan, pageCurrent, baseUrl, pageParameterName){
  ...
  this.inputData = {
    ...
    pageParameterName : pageParameterName ? pageParameterName : 'page'
  };
...
Paginator.prototype.drawPages = function(){
  ...
  for(var i=0; i<this.html.tdsPages.length; i++){
    ...
    if(cellCurrentValue == this.inputData.pageCurrent){
      ...
      html = "<span>" + "<a href='" + this.inputData.baseUrl + "&" + this.inputData.pageParameterName + "=" + cellCurrentValue + "'>" + cellCurrentValue + "</a>" + "</span>";
    }
